b5 = {}; 
b5.app = null, b5.data = {}, b5.version = 2.5, b5.nf = function() {}, 'use strict', function() {
...
b5.Actor.prototype.setBodyActive = function(e) {
  ...
  if ((this.x !== e || this.y !== t) && (this.x = e, this.y = t,this.onPositionSet && this.onPositionSet(e,t), this.dirty()), null !== this.body) {
    ...
    this.body.SetPosition(new o(e/a, t/a));
  ...
  b5.Actor.prototype.setOrigin = function(e, t) {
  	...
  	this.ox = (-this.w/2) * (e == "center" ? 0 : e == "left" ? -1 : e == "right" ? 1 : e);
  	this.oy = (-this.h/2) * (t == "center" ? 0 : t == "top" ? -1 : t == "bottom" ? 1 : t);
  	this.dirty();
...
b5.Actor.prototype.addJoint = function(e) {
  ...
  return a === o}, b5.Actor.prototype.draw = function() {
 	...
 	if((this.container.visible = this.visible && this.opacity && this._draw) || (this.atlas && (!this.w || !this.h))) {
  	this.accum_opacity = this.use_parent_opacity ? (this.parent || this.scene || b5.app).accum_opacity * this.opacity : this.opacity;
 ...
 b5.Actor.prototype.baseUpdate = function(e) {
  if (this.active) {
  	...
  	this._draw = this.cull && this.w > 0 && this.h > 0 ? !this.offscreen : !0;
    ...
    0 !== this.vd && (this.depth += this.vd*e, this.vd *= this.vd_damping);
...
b5.MapActor.prototype.getTileFromPosition = function(e, t, o) {
 ...
 b5.App = function(e, t, o, a) {
  ...
  this.touch_drag_x = 0,
  this.touch_drag_y = 0,
  this.accurate_timing = !!a,
  this.last_time = b5.NOW(),
  this.dt = 0,
...
b5.App.prototype.mainDraw = function() {
  ...
  b5.App.prototype.setResolution = function(e,t) {
    ...
    o.display_height = t,
    o.onResizeBase(),
    window.resizeTo(e - (!!window.electron ? 52 : 0),t);
  },
...
b5.Maths.wrap = function(n, min, max) {
	//Wrap n between min and max
	let m = Math.abs(min),
	o = max + m;
  n += m;
	return min + (o * b5.Maths.fract(n / o));
},
...
*/
  ...
  b5.Bitmap = function(e, t, o, a, n) {
	...
	r = (b5.app && (b5.app.use_image_bitmaps ? b5.app.texture_resolution : 1)),
...
//	this.image.addEventListener('load', function() {
 e.resource ? e.resource._onLoad$1 = () => {
		if(!e.loaded) {
			e.resolution = e.resource ? e.resource.resolution : (b5.app.use_image_bitmaps ? b5.app.texture_resolution : 1),
			b5.app && b5.app.onResourceLoaded(e, !1),
			e.onload && e.onload(e, !0);
		}
	} : e.loaded = true;
	this.image.addEventListener && this.image.addEventListener('error',function(o) {
...
b5.Bitmap.prototype.reload = function(e) {
	const t = this.onload, o = this.onerror;
  b5.Bitmap.call(this, this.name, e || this.location);
...
b5.NOW = function() {
	return b5.app.accurate_timing ? performance.now() : Date.now();
}
