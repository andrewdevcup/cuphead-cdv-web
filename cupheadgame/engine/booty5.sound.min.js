...
b5.Sound.init = function(e, t) {
	...
	this.IR_buffer = this.generateImpulseResponse(t.reverbGenerator || this.reverbSoft,t.reverbTime || 1);
},
...
//Reverb effect
b5.Sound.reverbSoft = function(sample, length) {
	var p = 1-(sample/length);
	return ((Math.random()*2)-1) * p * p * p * p;
},
b5.Sound.reverbMedium = function(sample, length) {
	var p = 1-(sample/length);
	return ((Math.random()*2)-1) * p * p * p;
},
b5.Sound.reverbFar = function(sample, length) {
	var p = 1-(sample/length);
	return ((Math.random()*2)-1) * p * p;
},
b5.Sound.reverbStrong = function(sample, length) {
	var p = 1-(sample/length);
	return ((Math.random()*2)-1) * p;
},
